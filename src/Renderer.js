...
import { background1, background2, background3 } from './assets.js';
...
export class Renderer {
  ...
  drawBackground() {
    for (let y = 0; y < this.windowHeight; y++) {
      const line = background3[y % background3.length];
  ...
  updateScroll() {
    this.scrollOffset = (this.scrollOffset + 1) % background3[0].length;
  }
